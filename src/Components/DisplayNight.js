...
function Display(props) {
    ...
    const divStyle = { textAlign: 'center', fontSize: '1.75em', color: 'white', fontFamily: '"Balsamiq Sans", cursive' }
    const activeStyle = { textAlign: 'center', fontSize: '1.75em', color: 'white', fontFamily: '"Balsamiq Sans", cursive', backgroundColor: '#3282b8' }
    ...
    return (
        <>
            ...
            <div style={{ textAlign: 'center', fontFamily: '"Balsamiq Sans", cursive', fontSize: '2em', color: 'white' }} className='col-lg-3 m-auto p-lg-2'>
            ...
            <div className='row'>
                {seven_days.map(item => {
                    return (
                        <div style={item.dt.toString().split(' ')[2] === props.active ? activeStyle : divStyle} className='col-xl-2 mx-auto mt-lg-5' id='daily_night' onClick={() => props.handleClick(item.dt)}>
                            <span>{item.dt}</span>
                            <br />

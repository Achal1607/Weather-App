...
function Display(props) {
    ...
    const divStyle = { opacity: "0.90", backgroundColor: '#528AAE', textAlign: 'center', fontSize: '2em', color: 'white', fontFamily: '"Balsamiq Sans", cursive' }
    return (
        <>
            <div style={{ opacity: "0.94", backgroundColor: '#528AAE', textAlign: 'center', fontSize: '2.5em', color: 'white' }} className='col-lg-3 m-auto p-lg-2'>
                <h2 style={{ fontFamily: '"Aclonica",sans-serif', fontSize: '2.5em' }}>{temp + '\u00B0C '}</h2>
            ...
            <div className='d-flex'>
                ...
                <div style={divStyle} className='col-lg-3 mx-auto mt-lg-3'>
                    <span style={{ color: '#121212' }}>Today</span>
                    <br />
                ...
                <div style={divStyle} className='col-lg-3 mx-auto mt-lg-3'>
                    <span style={{ color: '#121212' }}>Tommorow</span>
                    <br />
                ...
                <div style={divStyle} className='col-lg-3 mx-auto mt-lg-3'>
                    <span style={{ color: '#121212' }}>{props.day[2].dt}</span>
                    <br />
